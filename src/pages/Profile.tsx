...
export default function Profile() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest(`/api/users/${authUser.id}/profile`, {
        method: "GET",
      });
      return response;
    },
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container py-20">
          <Card className="mx-auto max-w-md p-8 text-center">
            <h2 className="mb-4 text-2xl font-bold">Profile Error</h2>
            ...
            {listings.length === 0 ? (
              <Card className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  You haven't posted any items for sale yet. Start selling to
